...
vim.keymap.set('n', '<leader>w', 'viw', { desc = 'Select [W]ord' })
...
require('lazy').setup({
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader>ps', require('telescope.builtin').lsp_dynamic_workspace_symbols, '[P]project [S]ymbols')
      ...
      local servers = {
        ...
        sqls = {
          on_attach = function(client)
            -- Disable document formatting capabilities for sqls
      ...
      vim.list_extend(ensure_installed, {
        ...
        'gopls', -- Used to format golang code
        'docker_compose_language_service',
        'dockerls',
      })
  ...
  },
  {
    ...
    lazy = false, -- Load on startup (optional; adjust based on your needs)
    config = function()
